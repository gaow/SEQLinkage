# AUTOGENERATED! DO NOT EDIT! File to edit: 07_plotped.ipynb (unless otherwise specified).
...
def plotped(fi,output=False,folder=''):
    #nodes
    #create iid nodes
    #create parent nodes
    #edges
    ...
    if output:
        dot.render(outfile=folder+'/ADfam_'+str(list(fi.fid)[0])+'.svg',format='svg',overwrite_source=True)
        dot.render(outfile=folder+'/ADfam_'+str(list(fi.fid)[0])+'.png',format='png',overwrite_source=True)
    return dot